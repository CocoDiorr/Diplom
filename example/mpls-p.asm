...
ori 0x12
store METADATA_PORTMASK, 0x20
// for swap label match flow is different:
...
loadbe (HEADER_START+14), 0x10
rol 0x8
orbe (HEADER_START+16), 0x8
// zeroing lower 20 bits:
andi 0xfff00000
// add label
ori 0x4400
// add BoS
ori 0x1
storebe (HEADER_START+16), 0x8
ror 0x8
...
impose_after_swap:
// just insert few headers with BoS 0 and iteratively set TTL byte
j finish
