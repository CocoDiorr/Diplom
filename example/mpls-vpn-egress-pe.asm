...
loadoffi 0
load (METADATA_PORTMASK+0x4), 0x8
// we need to mark control path for l3 processing
ori 0x2
store (METADATA_PORTMASK+0x4), 0x8
j shrink_headers
...
l3_nh:
// load daddr, walk through tree, replace smac/dmac, ttl was already decremented or > 1
// see mpls-ingress.asm for sample
// load dmac, switch to 0 offset and select port
j finish
